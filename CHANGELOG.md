## v0.1.62 - Additional K-Center
* **Commit**: 2026-03-11 17:06
* Add `weighted` to K-Center
...
* data.Task, SlotSched
* ConstraintFn.noMachineOverlap
* ScoreFn.scheduleMakespan 
* StringFn.shopSchedule
...
* **Commit**: 2026-02-27 21:22
* Add `weighted` to Set Packing
## v0.1.49 - Additional Set Splitting
* **Commit**: 2026-02-26 20:38
...
* Constraint.increasingSubsequence
